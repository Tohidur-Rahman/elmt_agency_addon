...
class Agency_Testimonial_Section extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Testimonials Widget', 'elmntr-agency' );
	}
    ...
    protected function register_controls(){
		...
		$this->add_control(
			'clients',
			[
				'label' => esc_html__( 'Clients List', 'elmntr-agency' ),
