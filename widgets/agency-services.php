...
class Agency_Services_Section extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Services Section', 'elmntr-agency' );
	}
    ...
    protected function register_controls(){
		...
		$repeater->add_control(
			'service_media_type',
			[
				'label' => esc_html__( 'Select Media Type', 'elmntr-agency' ),
				'type' => \Elementor\Controls_Manager::CHOOSE,
				'options' => [
					'service_icon' => [
						'title' => esc_html__( 'Icon', 'elmntr-agency' ),
						'icon' => 'eicon-menu-bar',
					],
					'service_image' => [
						'title' => esc_html__( 'Image', 'elmntr-agency' ),
						'icon' => 'eicon-featured-image',
					],
					'service_number' => [
						'title' => esc_html__( 'Number', 'elmntr-agency' ),
		...
		$repeater->add_control(
			'service_title', [
				...
				'default' => esc_html__( 'Web Design', 'elmntr-agency' ),
				'label_block' => true,
			],
		...
		$repeater->add_control(
			'service_desc', [
				...
				'default' => esc_html__( 'Lorem ipsum dummy text.', 'elmntr-agency' ),
				'label_block' => true,
			],
		...
		$this->add_control(
			'service_lists',
			[
				'label' => esc_html__( 'Services List', 'elmntr-agency' ),
