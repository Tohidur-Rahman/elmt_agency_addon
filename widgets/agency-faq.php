...
class Agency_FAQ_Section extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'FAQ & Skills Widget', 'elmntr-agency' );
	}
    ...
    protected function register_controls(){
        ...
        $this->start_controls_section(
			'faq_section',
			[
				'label' => esc_html__( 'FAQ Content', 'elmntr-agency' ),
		...
		$this->add_control(
			'faq_title',
			[
				'label' => esc_html__( 'FAQ Title', 'elmntr-agency' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( 'FAQ', 'elmntr-agency' ),
		...
		$this->start_controls_section(
			'skills_section',
			[
				'label' => esc_html__( 'Skills Content', 'elmntr-agency' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'skills_title',
			[
				'label' => esc_html__( 'Skills Title', 'elmntr-agency' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( 'Our SKILLS', 'elmntr-agency' ),
				'placeholder' => esc_html__( 'Type your title here', 'elmntr-agency' ),
				'label_block' => true,
			]
		);
		...
		$this->start_controls_section(
			'faq_style_section',
			[
				'label' => esc_html__( 'FAQ Style', 'elmntr-agency' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'FAQ Accordion Title', 'elmntr-agency' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'FAQ Accordion Description', 'elmntr-agency' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Skills Style', 'elmntr-agency' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'skill_title_style',
			[
				'label' => esc_html__( 'Skill Title', 'elmntr-agency' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'skill_list_style',
			[
				'label' => esc_html__( 'Skill Lists', 'elmntr-agency' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Percentage Color', 'elmntr-agency' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Percentage Background', 'elmntr-agency' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
